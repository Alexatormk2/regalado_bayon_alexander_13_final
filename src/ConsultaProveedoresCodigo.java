...
public class ConsultaProveedoresCodigo {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (codigo.equals("")) {
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = conexion.prepareStatement("SELECT  * FROM PROVEEDORES WHERE upper( codigo) like ? ");
                        pstmt.setString(1, "%" + codigo + "%");
                        pstmt.executeQuery();
                        while (pstmt.getResultSet().next()) {


                            comboProveedorCodigo.addItem(String.valueOf(pstmt.getResultSet().getInt(1)));
