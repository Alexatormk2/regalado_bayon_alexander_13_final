...
public class ConsultaPiezasNombre {
    JPanel panelConsultaPiezasNombre;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nombre.equals("")) {
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = conexion.prepareStatement("SELECT  * FROM PIEZAS WHERE upper( nombre) like ? ");
