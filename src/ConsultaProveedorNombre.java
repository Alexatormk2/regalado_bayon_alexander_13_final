...
public class ConsultaProveedorNombre {
    ...
    private JPanel panelConsultaProveedoresNombre;
     JPanel panelConsultasNombreProveedor;

    public ConsultaProveedorNombre() {
        ...
        buttonBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                nombre = textBuscarCodigoProveedor.getText().toUpperCase();
                if (nombre.equals("")) {
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = conexion.prepareStatement("SELECT  * FROM PROVEEDORES WHERE upper( nombre) like ? ");
