...
public class ConsultarNombreProyecto {
    ...
    public ConsultarNombreProyecto() {
        buttonBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                nombre = textBuscar.getText().toUpperCase();
                if (nombre.equals("")) {
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = conexion.prepareStatement("SELECT  * FROM Prpyectos WHERE upper( nombre) like ? ");
